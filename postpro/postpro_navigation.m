...
if ~isMC
    ...
    plot( ... 
        simTime, ... 
        eulerAngles(1, :) - eulerAnglesNav(1, :) .* (180 / pi), ... 
        'Color', 'b', ... 
        'LineStyle', '-', ... 
        'LineWidth', 2, ... 
        'DisplayName', errLeg);
    ...
    plot( ... 
        simTime, ... 
        eulerAngles(2, :) - eulerAnglesNav(2, :) .* (180 / pi), ... 
        'Color', 'b', ... 
        'LineStyle', '-', ... 
        'LineWidth', 2, ... 
        'DisplayName', errLeg);
    ...
    plot( ... 
        simTime, ... 
        eulerAngles(3, :) - eulerAnglesNav(3, :) .* (180 / pi), ... 
        'Color', 'b', ... 
        'LineStyle', '-', ... 
        'LineWidth', 2, ... 
        'DisplayName', errLeg);
    ...
    plot( ... 
        simTime, ... 
        abs(omgBod(1, :) - omgBodNav(1, :)) .* (180 / pi), ... 
        'Color', 'b', ... 
        'LineStyle', '-', ... 
        'LineWidth', 2);
